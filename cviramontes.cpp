...
bool playerCollision (float x1, float y1, float width1, 
...
void moveEnemyToPlayer (float enemyX, float enemyY, 
			float playerX, float playerY, float deltaTime) 
{ 
	...
	if (!playerCollision(nextX, nextY, enemyWidth, enemyHeight, 
